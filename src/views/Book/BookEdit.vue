            ...
            <div class="card-body">
                <ValidationObserver ref="observer" v-slot="{ invalid }" tag="form">
                                            ...
                                            <swiper-slide v-for="photo in book.bookPhotos" :key="photo.id">
                                                <img
                                                    :src="
                                                        ...
                                                        photo.extension
                                                    "
                                                    class="bookPhoto img-thumbnail rounded mx-auto d-block"
                                                    :alt="photo.name" />
                                    ...
                                    <ValidationProvider v-slot="{ valid, errors, validate }" name="檔案" rules="image">
                                        <div class="input-group">
                                            <input
                                                ...
                                                multiple
                                                @change="validate" />
                                            <button class="btn btn-primary btn-fill" type="button" @click="uploadImage">
                                                上傳
                                            </button>
                                            <span class="invalid-feedback">{{ errors[0] }}</span>
                                        </div>
                    ...
                    <div class="d-flex my-2">
                        ...
                        <button type="button" @click="$router.go(-1)" class="btn btn-primary btn-fill">回上一頁</button>
                    </div>
                </ValidationObserver>
            </div>
        </div>
...
import { apiGetBookPhoto, apiPostBookPhoto, apiPutBook, apiPostBook } from "api";
...
export default {
    ...
    methods: {
        ...
        //重載書籍圖片
        loadBookPhoto() {
            apiGetBookPhoto(`/BookPhoto/${this.$route.params.id}`)
                .then((response) => {
