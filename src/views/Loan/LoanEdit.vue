      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="col-md-12">
              ...
              <div class="pb-2">
                ...
                <ValidationProvider
                  v-slot="{ valid, errors }"
                  name="借閱帳號"
                  rules="excluded:00000000-0000-0000-0000-000000000000"
                >
                  <Select2
                    v-model="loan.accountId"
          ...
          <div class="d-flex my-2">
            <button
              class="btn btn-primary btn-fill me-2"
              :disabled="invalid"
              type="button"
              @click="onSubmit"
            >
...
export default {
  ...
  methods: {
    ...
    initDate() {
      ...
      console.log(currentDate.format("YYYY-MM-DD")); // later simply do this.
      this.loan.issueDate = currentDate.format("YYYY-MM-DD"); //借閱開始日期
      this.loan.dueDate = currentDate.add(5, 'days').format("YYYY-MM-DD"); //借閱結束日期
    },
  },
  created() {
    //編輯
